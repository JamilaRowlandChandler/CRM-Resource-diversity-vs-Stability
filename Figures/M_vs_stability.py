...
df_simulation = pd.read_csv(file_directory_name.removesuffix("\\figures") + \
                            "\\Data\\simulation_dataframes\\M_vs_mu_c.csv")
    
globally_solved_sces = pd.read_pickle(file_directory_name.removesuffix("\\figures") + \
                                      "\\Data\\self_consistency_equations\\M_vs_mu_c.pkl") 

solved_boundary = pd.read_pickle(file_directory_name.removesuffix("\\figures") + \
                                 "\\Data\\self_consistency_equations\\stability_bound\\M_vs_mu_c.pkl")
...
def Stability_Plot(df_simulation, globally_solved_sces, solved_boundary):
    ...
    chaotic_populations = pd.read_pickle(file_directory_name.removesuffix("\\figures") + \
                                          "\\Data\\example_communities\\" + \
                                              "simulations_75_1.9333.pkl")
        
    stable_populations = pd.read_pickle(file_directory_name.removesuffix("\\figures") + \
                                          "\\Data\\example_communities\\" + \
