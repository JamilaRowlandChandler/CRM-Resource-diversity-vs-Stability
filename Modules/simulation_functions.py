...
print(file_directory_name)

sys.path.insert(0, file_directory_name + "\\Consumer-resource models")
...
def CRM_across_parameter_space(parameter_sets : list[dict],
    ...
    for name, M, S, growth_consumption_rates_args, model_specific_rates_args in \
        ...
        CRMs_create_and_save(directory + "/simulations_" + name,
...
def CRMs_create_and_save(filepath : str,
    ...
    **kwargs : any
    ...
    pickle_dump(filepath + ".pkl", communities)
